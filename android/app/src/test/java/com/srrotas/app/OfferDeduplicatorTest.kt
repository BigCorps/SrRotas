...
class OfferDeduplicatorTest {
    ...
    private fun offer(service:String="black",type:String="radar",minutes:Int=24)=RideOffer(
        ...
        passengerRating=4.65,advertisedPerKm=4.16,serviceType=service,verdict="ruim",confidence=.9,offerType=type,dedupeKey="server-key"
    )
